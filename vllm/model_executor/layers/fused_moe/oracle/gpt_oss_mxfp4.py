...
def backend_to_kernel_cls(
    ...
    elif backend == GptOssMxfp4MoeBackend.AITER:
...
def map_mxfp4_backend(runner_backend: str) -> GptOssMxfp4MoeBackend:
    ...
    mapping: dict[str, GptOssMxfp4MoeBackend] = {
        ...
        "aiter": GptOssMxfp4MoeBackend.AITER,
...
def select_gpt_oss_mxfp4_moe_backend(
    ...
    if config.is_lora_enabled:
        ...
        return GptOssMxfp4MoeBackend.MARLIN, backend_to_kernel_cls(
            GptOssMxfp4MoeBackend.MARLIN
        )[0]
...
def convert_gpt_oss_weight_to_mxfp4_moe_kernel_format(
    ...
    elif mxfp4_backend == GptOssMxfp4MoeBackend.AITER:
